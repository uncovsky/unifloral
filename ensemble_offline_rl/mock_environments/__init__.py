...
from mock_environments.continuous_bandit import ContinuousBandit, DDimensionalBandit
...
register(
    id="DDimensionalBandit-v0",
    entry_point="mock_environments.continuous_bandit:DDimensionalBandit",
    max_episode_steps=1,  # one step and then terminal
)
