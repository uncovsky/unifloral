...
def main(config_path):
    ...
    project_name = base_sweep_config.get("project", "default-project")
    entity_name = base_sweep_config.get("entity", None)
    ...
    for env in envs:
        ...
        # 5 seeds for each env
        wandb.agent(sweep_id, function=None, count=5)
